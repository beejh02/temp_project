...
export const demoMissions = [
  ...
  },
  {
    ...
    target: {
      ...
      location: { latitude: 36.32785, longitude: 127.4284 },
    },
  ...
  {
    id: 3,
    missionKey: "first-three-store-visit",
    group: MISSION_GROUP.SPECIAL,
    category: MISSION_CATEGORY.CHALLENGE,
    title: "선착순 3명 반찬가게 방문",
    description: "남은 자리 안에 지정 반찬가게를 방문해보세요.",
    activationReason:
      "선착순 참여가 지금 시장을 방문해야 할 분명한 계기를 만들어요.",
    status: MISSION_STATUS.IN_PROGRESS,
    reward: 9,
    target: {
      type: MISSION_TARGET_TYPE.STORE,
      storeId: 102,
      name: "황금찬 반찬가게",
      address: "대전 중앙시장 먹자골목",
      location: { latitude: 36.3271, longitude: 127.42675 },
    },
    verificationLabel: "지정 점포 반경 30m 이내 위치와 완료 순서로 확인",
    progress: { current: 2, target: 3, label: "2명 완료" },
    availability: {
      capacity: 3,
      remainingSlots: 1,
      endsAtLabel: "남은 자리 소진 시 마감",
    },
  },
  {
    id: 4,
